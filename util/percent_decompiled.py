...
dol_progress = simple_count("./pack/dol_slices.csv")
rel_progress = simple_count("./pack/rel_slices.csv")

dol_total = binary_total("./pack/dol_segments.csv")
rel_total = binary_total("./pack/rel_segments.csv")
...
egg_progress = [0, 0]
for o_name, o_code_total, o_data_total in parse_slices("./pack/dol_slices.csv"):
