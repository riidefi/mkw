...
from mkw.rel import Rel, RelSection
...
def build_elf(rel_path, elf_path):
    ...
    # TODO hardcoded path
    rel.load_reloc(0, "./orig/pal/rel/dol_rel.bin")
    rel.load_reloc(1, "./orig/pal/rel/rel_abs.bin")
