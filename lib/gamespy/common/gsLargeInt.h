...
gsi_bool gsLargeIntPowerMod(const gsLargeInt_t* base, const gsLargeInt_t* power,
...
gsi_bool gsLargeIntAdd(const gsLargeInt_t* src1, const gsLargeInt_t* src2,
                       gsLargeInt_t* dest);
gsi_bool gsLargeIntSub(const gsLargeInt_t* src1, const gsLargeInt_t* fromsrc2,
                       gsLargeInt_t* dest);
...
// This is useful when packing a BigEndian message directly into a LittleEndian
// lint buffer.
