...
bool CourseColManager::checkPointFull(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  this->kclScale = scale;
...
bool CourseColManager::checkPointFullPush(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  this->kclScale = scale;
...
bool CourseColManager::checkSphereFull(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale, f32 radius) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  this->kclScale = scale;
...
bool CourseColManager::checkSphereFullPush(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale, f32 radius) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  this->kclScale = scale;
...
bool CourseColManager::checkPointCachedFull(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  if (colMgr->getPrismCache(0) == 0) {
...
bool CourseColManager::checkPointCachedFullPush(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  if (colMgr->getPrismCache(0) == 0) {
...
bool CourseColManager::checkSphereCachedFull(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale, f32 radius) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  if (colMgr->getPrismCache(0) == 0) {
...
bool CourseColManager::checkSphereCachedFullPush(RKGndCol* colMgr, const EGG::Vector3f& pos, const EGG::Vector3f& prevPos, u32 typeMask, ColInfoFull* colInfo, u32* typeMaskOut, f32 scale, f32 radius) {
  if (colMgr == nullptr) {
    colMgr = this->colMgr;
  }
  if (colMgr->getPrismCache(0) == 0) {
