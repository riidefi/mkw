...
// PAL: 0x80590cf8
extern UNKNOWN_FUNCTION(PlayerPointers_getPlayerSub10Speed);
// PAL: 0x80590d08
...
// PAL: 0x80590dc0
extern UNKNOWN_FUNCTION(PlayerPointers_getSpeedRatioCapped);
// PAL: 0x80590e04
...
// PAL: 0x805914bc
extern UNKNOWN_FUNCTION(PlayerPointers_getScale);
// PAL: 0x8059152c
...
MARK_BINARY_BLOB(PlayerSub10_computeWallCollisionSpeedFactor, 0x8057b108, 0x8057b29c);
...
MARK_BINARY_BLOB(PlayerSub10_getWheelieSoftSpeedLimitBonus, 0x8057c3c8, 0x8057c3d4);
...
MARK_BINARY_BLOB(PlayerSub10_updateVehicleRotationVector, 0x8057cf0c, 0x8057d1d4);
...
MARK_BINARY_BLOB(unk_8057efe0, 0x8057efe0, 0x8057efec);
asm UNKNOWN_FUNCTION(unk_8057efe0) {
  #include "asm/8057efe0.s"
}

// Symbol: unk_8057efec
// PAL: 0x8057efec..0x8057eff8
MARK_BINARY_BLOB(unk_8057efec, 0x8057efec, 0x8057eff8);
asm UNKNOWN_FUNCTION(unk_8057efec) {
  #include "asm/8057efec.s"
}

// Symbol: unk_8057eff8
// PAL: 0x8057eff8..0x8057f024
MARK_BINARY_BLOB(unk_8057eff8, 0x8057eff8, 0x8057f024);
asm UNKNOWN_FUNCTION(unk_8057eff8) {
...
MARK_BINARY_BLOB(unk_80581720, 0x80581720, 0x8058173c);
asm UNKNOWN_FUNCTION(unk_80581720) {
  #include "asm/80581720.s"
}
...
MARK_BINARY_BLOB(unk_80581a24, 0x80581a24, 0x80581a28);
asm UNKNOWN_FUNCTION(unk_80581a24) {
  #include "asm/80581a24.s"
}
...
MARK_BINARY_BLOB(unk_805832e4, 0x805832e4, 0x80583424);
asm UNKNOWN_FUNCTION(unk_805832e4) {
...
MARK_BINARY_BLOB(PlayerSub10Bike_updateVehicleRotationVector, 0x80587d68, 0x80588324);
...
MARK_BINARY_BLOB(PlayerSub10Bike_getWheelieSoftSpeedLimitBonus, 0x80588324, 0x80588350);
