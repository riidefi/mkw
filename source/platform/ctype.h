...
inline int isalnum(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_alnum);
}
inline int isalpha(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_alpha);
}
#if _MSL_C99 /*- mm 030226 -*/
inline int isblank(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_blank);
}
#endif /* _MSL_C99 */ /*- mm 030226 -*/
inline int iscntrl(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_cntrl);
}
inline int isdigit(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_digit);
}
inline int isgraph(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_graph);
}
inline int islower(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_lower);
}
inline int isprint(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_print);
}
inline int ispunct(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_punct);
}
inline int isspace(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_space);
}
inline int isupper(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_upper);
}
inline int isxdigit(int c) {
  return ((c < 0) || (c >= __msl_cmap_size))
             ? 0
             : (int)(_MSL_CMAP_ACCESS[c] & __msl_xdigit);
}
inline int tolower(int c) {
  return ((c < 0) || (c >= __msl_cmap_size)) ? c : (int)(_MSL_CLOWER_ACCESS[c]);
}
