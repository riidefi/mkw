...
///////////////////////////////////////////////////////////////
GHTTPBool
ghiInitFixedBuffer(struct GHIConnection* connection, // The connection.
                   GHIBuffer* buffer,                // The buffer to init.
...
////////////////////////////////////////////////////
GHTTPBool
ghiAppendDataToBuffer(GHIBuffer* buffer, // The buffer to append to.
                      const char* data,  // The data to append.
                      int dataLen // The number of bytes of data to append, 0
...
////////////////////////////////////////////////////
GHTTPBool
ghiEncryptDataToBuffer(GHIBuffer* buffer, // The buffer to append to.
                       const char* data,  // The data to append.
                       int dataLen // The number of bytes of data to append, 0
                                   // for NUL-terminated string.
);
...
GHTTPBool ghiReadDataFromBufferFixed(GHIBuffer* bufferIn, char bufferOut[],
                                     int len);
