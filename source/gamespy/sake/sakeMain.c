...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void SAKE_CALL sakeSetGame(SAKE sake, const gsi_char* gameName, int gameId,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void SAKE_CALL sakeSetProfile(SAKE sake, int profileId,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static inline SAKERequest SAKE_CALL sakeiRunRequest(
    SAKE sake, void* input, SAKERequestCallback callback, void* userData,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeCreateRecord(SAKE sake, SAKECreateRecordInput* input,
                                       SAKERequestCallback callback,
                                       void* userData) {
  return sakeiRunRequest(sake, input, callback, userData,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeUpdateRecord(SAKE sake, SAKEUpdateRecordInput* input,
                                       SAKERequestCallback callback,
                                       void* userData) {
  return sakeiRunRequest(sake, input, callback, userData,
                         SAKEIRequestType_UPDATE_RECORD,
                         sakeiStartUpdateRecordRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
/*
SAKERequest SAKE_CALL sakeDeleteRecord(SAKE sake, SAKEDeleteRecordInput *input,
SAKERequestCallback callback, void *userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_DELETE_RECORD, sakeiStartDeleteRecordRequest);
}
*/
...
SAKERequest SAKE_CALL sakeSearchForRecords(SAKE sake,
  ...
  return sakeiRunRequest(sake, input, callback, userData,
                         ...
                         sakeiStartSearchForRecordsRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetMyRecords(SAKE sake, SAKEGetMyRecordsInput* input,
                                       SAKERequestCallback callback,
                                       void* userData) {
  return sakeiRunRequest(sake, input, callback, userData,
                         SAKEIRequestType_GET_MY_RECORDS,
                         sakeiStartGetMyRecordsRequest);
}
...
SAKEGetSpecificRecordsInput *input, SAKERequestCallback callback, void
*userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_GET_SPECIFIC_RECORDS, sakeiStartGetSpecificRecordsRequest);
}


///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRandomRecord(SAKE sake, SAKEGetRandomRecordInput
*input, SAKERequestCallback callback, void *userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_GET_RANDOM_RECORD, sakeiStartGetRandomRecordRequest);
}


///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeRateRecord(SAKE sake, SAKERateRecordInput *input,
SAKERequestCallback callback, void *userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_RATE_RECORD, sakeiStartRateRecordRequest);
}


///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordLimit(SAKE sake, SAKEGetRecordLimitInput
*input, SAKERequestCallback callback, void *userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_GET_RECORD_LIMIT, sakeiStartGetRecordLimitRequest);
}


///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordCount(SAKE sake, SAKEGetRecordCountInput
*input, SAKERequestCallback callback, void *userData)
{
        return sakeiRunRequest(sake, input, callback, userData,
SAKEIRequestType_GET_RECORD_COUNT, sakeiStartGetRecordCountRequest);
}
...
SAKEField * SAKE_CALL sakeGetFieldByName(const char *name, SAKEField *fields,
int numFields)
{
        int i;
...
gsi_bool SAKE_CALL sakeSetFileDownloadURL(SAKE sake,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
gsi_bool SAKE_CALL sakeGetFileDownloadURL(SAKE sake, int fileId,
                                          gsi_char url[SAKE_MAX_URL_LENGTH]) {
  int rcode;
  ...
  if (!sake || !url || !sake->mIsGameAuthenticated ||
      !sake->mIsProfileAuthenticated)
    return gsi_false;

  if (gSakeDownloadUrlOverride[0] != '\0') {
    // modification, injected fileId here.
    rcode = _tsnprintf(
        url, SAKE_MAX_URL_LENGTH, _T("%s?fileid=%d&gameid=%d&pid=%d"),
        gSakeDownloadUrlOverride, fileId, sake->mGameId, sake->mProfileId);
  } else {
    rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
                       _T("http://%s.sake.%s/SakeFileServer/")
                       _T("download.aspx?fileid=%d&gameid=%d&pid=%d"),
                       sake->mGameName, GSI_DOMAIN_NAME, fileId, sake->mGameId,
                       sake->mProfileId);
  }
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
gsi_bool SAKE_CALL sakeSetFileUploadURL(SAKE sake,
                                        gsi_char url[SAKE_MAX_URL_LENGTH]) {
  GS_ASSERT(sake);
  GS_ASSERT(url);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
gsi_bool SAKE_CALL sakeGetFileUploadURL(SAKE sake,
                                        gsi_char url[SAKE_MAX_URL_LENGTH]) {
  int rcode;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static gsi_bool SAKE_CALL sakeiGetHeaderValueInt(const char* headers,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
gsi_bool SAKE_CALL sakeGetFileResultFromHeaders(const char* headers,
                                                SAKEFileResult* result) {
  int resultCode;
  gsi_bool foundResultCode;

  foundResultCode =
      sakeiGetHeaderValueInt(headers, SAKE_FILE_RESULT_HEADER, &resultCode);
