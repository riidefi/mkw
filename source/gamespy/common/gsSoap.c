...
static GHTTPBool gsiSoapTaskHttpCompletedCallback(GHTTPRequest request,
  ...
  if (result == GHTTPSuccess) {
    ...
    if (aSoapTask->mResponseSoap == NULL) {
      ...
      parseResult =
          gsXmlParseBuffer(aSoapTask->mResponseSoap, buffer, (int)bufferLen);
...
//   - return anything else           for "finished - trigger callback and
//   delete"
static GSTaskResult gsiSoapTaskThink(void* theTask) {
...
static void gsiSoapTaskExecute(void* theTask) {
  ...
  aSoapTask->mRequestId =
      ghttpGetExA(aSoapTask->mURL, aSoapTask->mService, NULL, 0,
                  aSoapTask->mPostData, GHTTPFalse, GHTTPFalse, NULL,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
// After the soap call has completed, launch a separate cleanup event (see
// comments)
static gsi_bool gsiSoapTaskCleanup(void* theTask) {
  GSSoapTask* aSoapTask = (GSSoapTask*)theTask;
