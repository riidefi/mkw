...
#define UTF8String                                                             \
  char* // may not be NULL terminated when treated as a single character
...
#define UTF8_IS_TWO_BYTE(a)                                                    \
  (((UTF8ByteType)a & UTF8_THREE_BYTE_TAG) == UTF8_TWO_BYTE_TAG)
#define UTF8_IS_FOLLOW_BYTE(a)                                                 \
  (((UTF8ByteType)a & UTF8_TWO_BYTE_TAG) == UTF8_FOLLOW_BYTE_TAG)
...
// similar to strncpy
// int UCS2ToUTF8StringLength(const UCS2String theUCS2String, UTF8String
