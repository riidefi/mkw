...
)
{
	...
	if (profile->buddyStatusInfo && iconnection->infoCachingBuddyAndBlockOnly == 0)
	{
	...
	if ((!profile->cache) ||
		(iconnection->infoCachingBuddyAndBlockOnly==GPITrue && profile->buddyStatus == 0 && profile->buddyStatusInfo == 0))
	{
