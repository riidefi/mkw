...
GHTTPRequest ghttpGetExA(
    const char* URL,     // The URL for the file
                         // ("http://host.domain[:port]/path/filename").
    const char* headers, // Optional headers to pass with the request.  Can be
                         // NULL or "".
...
////////////////////////////////////
GHTTPBool
ghttpPostAddStringA(GHTTPPost post,    // The post object to add to.
